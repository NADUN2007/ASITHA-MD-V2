...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=PuwS3QTK#t2oQccjsBMUIPI-gFHFjfA1pKLlR0qkeCPOv1rc-cA0' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
ALIVE_MSG: process.env.ALIVE_MSG === undefined ? "*Hello , I am Mdnoli_MD alive now!!*" : process.env.ALIVE_MSG,
